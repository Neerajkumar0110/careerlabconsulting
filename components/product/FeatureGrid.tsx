      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-10 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 md:mb-24">
          ...
          <p className="text-slate-400 text-lg md:text-xl leading-relaxed">
            Integrate, deploy, and scale our autonomous AI products for communications, operations, finance, HR, and learning — all running seamlessly without supervision.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
          {features.map((feature, i) => (
            <article 
              key={i} 
              className="group relative p-8 pb-5 pt-6 rounded-3xl bg-slate-900/30 border border-white/5 hover:border-blue-500/30 transition-all duration-500 hover:-translate-y-2 flex flex-col h-full"
            >
              ...
              {/* Bottom Action - Pushed down by mt-auto */}
              <div className="mt-auto pt-8 flex items-center text-[10px] font-black tracking-widest text-blue-400 opacity-0 group-hover:opacity-100 transition-all transform translate-y-2 group-hover:translate-y-0 uppercase relative z-10">
        ...
        <div className="mt-20 p-8 md:p-14 rounded-[2.5rem] bg-gradient-to-br from-blue-600 via-blue-700 to-indigo-800 flex flex-col md:flex-row items-center justify-between gap-10 shadow-2xl relative overflow-hidden group">
            ...
            <div className="text-center md:text-left relative z-10">
                <h3 className="text-3xl md:text-4xl font-bold text-white mb-3 tracking-tight">
                  Ready to deploy your AI ecosystem?
                </h3>
                <p className="text-blue-100/80 text-lg">
                  Join 500+ enterprises running Manee, TwinX, EduX, LegalOS, and more to scale autonomously.
                </p>
            </div>
