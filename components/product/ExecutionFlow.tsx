...
const DiscoveryIllustration = () => (
  <svg viewBox="0 0 80 80" className="w-full h-full illus-svg" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    {/* mini bar chart at bottom of doc */}
...
const NeuralIllustration = () => (
  <svg viewBox="0 0 80 80" className="w-full h-full illus-svg" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    {/* ── Brain silhouette ── */}
    {/* left hemisphere */}
    <path d="M24 46 C16 43 12 35 14 27 C16 19 23 15 30 17 C31 13 36 11 39 14"
      fill="none" stroke="#6366f1" strokeWidth="1.6" strokeLinecap="round"/>
    {/* right hemisphere */}
    <path d="M41 14 C44 11 49 13 50 17 C57 15 64 19 66 27 C68 35 64 43 56 46"
      fill="none" stroke="#818cf8" strokeWidth="1.6" strokeLinecap="round"/>
    {/* base join */}
    <path d="M24 46 C24 53 29 57 33 57 C34 60 37 61 40 60 C43 61 46 60 47 57 C51 57 56 53 56 46"
      fill="rgba(79,70,229,0.08)" stroke="#6366f1" strokeWidth="1.2"/>
    {/* centre divider */}
...
const IntegrationIllustration = () => (
  <svg viewBox="0 0 80 80" className="w-full h-full illus-svg" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    {/* ── Animated data-packet dots on paths ── */}
...
const LaunchIllustration = () => (
  <svg viewBox="0 0 80 80" className="w-full h-full illus-svg" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <circle cx="38.5" cy="28.5" r="1" fill="rgba(255,255,255,0.3)"/> {/* glint */}
    {/* body detail stripes */}
...
const steps = [
  ...
  },
  {
    ...
    Illustration: NeuralIllustration,
...
const Connector = ({ color }: ConnectorProps) => (
        ...
        <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-8 mb-6 md:mb-8">
          ...
          >
            ...
            <div
              ...
              style={{
                background:
                  "linear-gradient(135deg,rgba(120,53,15,0.45),rgba(2,6,23,0.95))",
              }}
            >
              {/* top shimmer bar */}
              ...
              <div className="p-5 sm:p-6">
                ...
                <div className="flex items-start gap-1 mb-1">
                  <span className="text-4xl md:text-5xl font-black text-white leading-none tracking-tighter">
                    <Counter to={40} suffix="%" duration={1800} />
                  </span>
                ...
                <p className="text-slate-400 text-xs leading-relaxed">
                  Average enterprise saving across 200+ deployments
                </p>
                ...
                <div className="mt-4 pt-4 border-t border-white/[0.06] grid grid-cols-2 gap-3">
                  {[
                    ...
                    <div key={s.label}>
                      <p className="text-white text-center md:text-left font-black text-xl md:text-lg leading-none">
                        {s.value}
                      </p>
                      <p className="text-slate-500 text-center md:text-left text-[12px] md:text-[10px] mt-0.5">
                        {s.label}
                      </p>
                    </div>
                  ))}
          ...
          {steps.map((step, idx) => (
            <React.Fragment key={step.id}>
              <motion.article
                ...
                className="group relative flex-1 flex flex-col rounded-2xl overflow-hidden cursor-default
              ...
              >
                ...
                <div className="flex flex-col flex-1 p-5 sm:p-6">
                  ...
                  {/* illustration box */}
                  <div className="relative w-full h-28 sm:h-32 mb-5 rounded-xl overflow-hidden flex items-center justify-center"
                    style={{ background: `radial-gradient(ellipse at 50% 50%, ${step.glow.replace('0.15','0.3')}, rgba(2,6,23,0.6))` }}>
                    {/* subtle grid */}
                    <div className="absolute inset-0 opacity-[0.07]"
                      style={{ backgroundImage: 'linear-gradient(rgba(255,255,255,0.3) 1px,transparent 1px),linear-gradient(90deg,rgba(255,255,255,0.3) 1px,transparent 1px)', backgroundSize: '16px 16px' }} />
                    <div className="relative w-32 h-32">
                      <step.Illustration />
                    </div>
                    {/* step number — top right of illustration */}
                    <span className="absolute top-2 left-2.5 text-[18px] md:text-[24px] font-mono font-black opacity-30" style={{ color: step.accent }}>{step.id}</span>
                  </div>
                  ...
                  <div className="mt-4 flex items-center justify-between opacity-40 group-hover:opacity-100 transition-all duration-300">
                    <div className="h-px w-6 group-hover:w-10 transition-all duration-300 rounded-full"
