      ...
      <div style={{ position:'relative',zIndex:2,textAlign:'center',maxWidth:860 }}>
        ...
        <motion.div initial={{ opacity:0,y:20 }} animate={{ opacity:1,y:0 }} transition={{ duration:0.7,delay:0.3,ease:[0.16,1,0.3,1] }}>
          ...
          <div style={{ display:'flex',justifyContent:'center',flexWrap:'wrap',gap:8,marginBottom:36 }}>
            ...
            <Tag scheme="mint"><GitBranch size={9}/>Verified Career Portfolio · GitHub Verified</Tag>
...
══════════════════════════════════════════════════════════════════════════════ */
const ECO = [
  { icon:BookOpen,   title:'InternX–AI',        tag:'Core Accelerator', desc:'6-month real-world Agentic AI internship with live startup projects, Verified Career Portfolio, and global hiring access.',        scheme:'violet' as const },
  ...
  { icon:Link2,      title:'Verified Career Portfolio',           tag:'Verified Career Portfolio', desc:'Tamper-proof credentials minted on-chain. GitHub + LinkedIn verified — 100% visible to global recruiters.',         scheme:'violet' as const },
...
const TECH_CUR = [
  {
    period: 'Months 1–3 · Foundation Phase',
    ext: false,
    title: 'Software & AI Engineering Fundamentals',
    desc: 'Build strong engineering foundations with Python, APIs, data systems, automation workflows, problem solving, software architecture and production-grade development practices.',
    tags: [
      'Python',
      'OOP',
      'REST APIs',
  ...
  {
    period: 'Months 4–6 · Applied AI Systems',
    ext: false,
    title: 'LLMs, RAG & Autonomous Agents',
    desc: 'Design intelligent AI systems using embeddings, vector databases, semantic search, RAG pipelines, agent memory, tool calling and multi-agent orchestration frameworks.',
    tags: [
      'LLMs',
      'RAG',
      'FAISS',
  ...
  {
    period: 'Months 7–9 · Advanced Extension',
    ext: true,
    title: 'Advanced AI Infrastructure',
    desc: 'Work with transformers, fine-tuning pipelines, inference optimization, distributed architectures, FastAPI services and scalable cloud-native AI deployment.',
    tags: [
      'Transformers',
      'Fine-Tuning',
      'FastAPI',
  ...
  {
    period: 'Months 10–12 · Enterprise Systems',
    ext: true,
    title: 'Enterprise AI & MLOps Engineering',
    desc: 'Deploy enterprise-grade AI platforms with Kubernetes, observability, CI/CD pipelines, monitoring, governance, security and production-scale multi-agent ecosystems.',
    tags: [
      'Kubernetes',
      'MLOps',
      'Docker',
...
const SCH = [
  ...
  ['Format', 'Live Theory + Hands-On Implementation'],
  ['Mode', '100% Online · Remote-First'],
  ['Mentorship', 'Weekly 1:1 Mentorship (Elite Plan)'],
  ['Assessment', '65–70% Minimum Performance Requirement'],
]
  ...
  return (
    <section id="program" style={{ position:'relative',background:T.ink,overflow:'hidden',padding:'110px 0 120px' }}>
      ...
      <div style={{ maxWidth:1200,margin:'0 auto',padding:'0 32px',position:'relative',zIndex:2 }}>
        ...
        <FadeIn>
          <SectionLabel>Curriculum — 6 &amp; 12 Month AI Engineering Program</SectionLabel>

          <Display>
            From Fundamentals<br/>
            <Grad>to Enterprise AI Systems.</Grad>
          </Display>
          ...
          <p style={{
            ...
            The <strong style={{ color:T.hi,fontWeight:500 }}>6-month core program</strong> builds strong AI engineering foundations through practical implementation and production-focused learning. Months 7–12 continue into the <strong style={{ color:T.gold,fontWeight:500 }}>Advanced Extension</strong>, focused on enterprise systems, cloud infrastructure, MLOps and scalable AI architectures.
          </p>
          ...
          <div style={{
            ...
            <span style={{
              ...
              One continuous AI Engineering journey — beginner to enterprise-level systems
            </span>
          </div>
        </FadeIn>
        ...
        <FadeIn delay={0.1}>
          <div style={{
            ...
            <Tag scheme="violet">234 hrs · 6 Months Core</Tag>
            <Tag scheme="gold">468 hrs · 12 Months Advanced</Tag>
            <Tag scheme="mint">Live Practical Implementation</Tag>
            <Tag scheme="cyan">Industry-Focused Projects</Tag>
          </div>
        </FadeIn>
              ...
              {TECH_CUR.map((u,i) => (
                <div
                  ...
                  style={{
                    ...
                    gap:20,
                    position:'relative',
                    paddingBottom:i<TECH_CUR.length-1?36:0
                  }}
                >
                  {i < TECH_CUR.length-1 && (
                    <div
                      style={{
                        ...
                        width:1,
                        background:u.ext
                          ? `linear-gradient(${T.gold}80,transparent)`
                          : `linear-gradient(${T.violet}80,transparent)`
                      }}
                    />
                  )}
            ...
            <div style={{ display:'flex',flexDirection:'column',gap:14 }}>
              ...
              <div style={{ position:'relative',overflow:'hidden',borderRadius:16,border:`0.5px solid ${T.violetB}`,padding:'22px',background:`linear-gradient(135deg,rgba(124,58,237,0.10) 0%,rgba(255,255,255,0.02) 100%)` }}>
                ...
                <div style={{ display:'flex',flexWrap:'wrap',gap:7 }}>
                  ...
                  <Tag scheme="gold">Verified Career Portfolio</Tag>
                </div>
              </div>
...
const AGENT_STEPS = [
  { label:'Research Agent',   sub:'SERP + data collection',     color:T.violet },
  { label:'Reasoning Layer',  sub:'LLMs + memory + tools',      color:'#A855F7' },
  { label:'RAG Pipeline',     sub:'Embeddings + retrieval',     color:T.mint },
  { label:'AI Generation',    sub:'Structured content output',  color:T.gold },
  { label:'Workflow Engine',  sub:'Multi-agent orchestration',  color:'#06B6D4' },
  { label:'Deploy & Monitor', sub:'Cloud + observability',      color:'#F43F5E' },
]

export function TechStack() {
  const tools = TECH_TOOLS
  ...
  return (
    <section id="techstack" style={{ position:'relative',background:T.void,overflow:'hidden',padding:'110px 0 120px' }}>
      ...
      <div style={{ maxWidth:1200,margin:'0 auto',padding:'0 32px',position:'relative',zIndex:2 }}>
        ...
        <FadeIn>
          <SectionLabel>AI Engineering Stack</SectionLabel>
          <Display>Production AI Tools,<br/><Grad>Used By Modern Teams.</Grad></Display>
          <Rule/>
          ...
          <p style={{
            ...
            Master the complete modern AI engineering ecosystem — from Python backend systems and LLM orchestration to vector databases, autonomous agents, cloud deployment and enterprise-grade MLOps workflows.
          </p>

          <div style={{ display:'flex',gap:8,flexWrap:'wrap',marginBottom:10 }}>
            <Tag scheme="violet">LLM Engineering</Tag>
            <Tag scheme="mint">Multi-Agent Systems</Tag>
            <Tag scheme="gold">Cloud Deployment</Tag>
            <Tag scheme="cyan">Production AI</Tag>
          </div>
        </FadeIn>
        ...
        <FadeIn delay={0.3}>
          <div
            style={{
              ...
              background:`linear-gradient(135deg,rgba(16,245,160,0.05) 0%,rgba(124,58,237,0.05) 100%)`,
              padding:'26px 22px'
            }}
          >
            <div
            ...
            >
              ...
              <Tag scheme="violet">ReAct Architecture</Tag>
              <Tag scheme="gold">Cloud Deployed</Tag>
            </div>
            ...
            >
              Build enterprise-grade AI systems with autonomous agents, RAG pipelines, memory layers, observability, cloud deployment and scalable orchestration workflows used in modern AI products.
            </p>
          </div>
        </FadeIn>
      </div>
