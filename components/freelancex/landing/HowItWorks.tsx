            ...
            >
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <button 
                  ...
                  type="submit" 
                  className="w-full bg-indigo-500 hover:bg-indigo-600 text-white font-bold py-4 rounded-xl transition-colors flex justify-center items-center gap-2"
                >
