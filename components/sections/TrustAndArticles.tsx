...
const TrustAndArticles = () => {
  ...
  const articles = [
    ...
    { title: 'What is Retrieval-Augmented Generation (RAG) for LLMs', img: 'https://img.freepik.com/free-photo/young-guy-aged-man-with-vr-glasses-sitting-settee_23-2148030187.jpg' },
