...
const MethodologySection = () => {
  ...
  return (
    <section className="relative py-16 md:py-32 px-4 md:px-12 bg-transparent overflow-hidden">
      
      <div className="absolute top-1/2 left-0 -translate-y-1/2 w-72 h-72 bg-blue-600/10 rounded-full blur-[120px] -z-10 animate-pulse"></div>
      <div className="absolute top-1/4 right-0 w-64 h-64 bg-indigo-600/10 rounded-full blur-[100px] -z-10"></div>
        ...
        <div className="flex flex-col lg:flex-row gap-16 lg:gap-24 items-center">
          ...
          <div className="w-full lg:w-1/2 space-y-10 text-center lg:text-left">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-6 justify-center lg:justify-start">
              <button className="group relative px-8 py-4 bg-blue-600 hover:bg-blue-500 text-white rounded-xl font-bold transition-all duration-300 shadow-[0_0_20px_rgba(37,99,235,0.3)] hover:shadow-blue-500/50 flex items-center gap-3 overflow-hidden">
                <div className="absolute inset-0 w-full h-full bg-gradient-to-r from-transparent via-white/20 to-transparent -translate-x-full group-hover:translate-x-full transition-transform duration-1000"></div>
                Explore Methodology
                <ArrowRight size={20} className="group-hover:translate-x-1 transition-transform" />
              </button>
              
              <a href="#" className="text-slate-500 hover:text-white font-bold tracking-widest text-xs uppercase border-b-2 border-transparent hover:border-blue-500 transition-all py-1">
                View Case Studies
              </a>
            </div>

            <div className="flex flex-row justify-center lg:justify-start gap-12 pt-12 border-t border-white/5">
              <div className="relative pl-6">
                <div className="absolute left-0 top-0 bottom-0 w-1 bg-gradient-to-b from-red-500 to-transparent"></div>
                <p className="text-4xl md:text-6xl font-black text-white">30+</p>
                <p className="text-[10px] uppercase tracking-widest text-slate-500 font-bold mt-2">Agents Live</p>
              </div>
              <div className="relative pl-6">
                <div className="absolute left-0 top-0 bottom-0 w-1 bg-gradient-to-b from-blue-500 to-transparent"></div>
                <p className="text-4xl md:text-6xl font-black text-white">5x</p>
                <p className="text-[10px] uppercase tracking-widest text-slate-500 font-bold mt-2">Avg. ROI</p>
              </div>
            </div>
          </div>
            ...
            {steps.map((step, index) => (
              ...
              >
                {index !== steps.length - 1 && (
                  <div className="hidden lg:block absolute right-[50%] top-full w-px h-10 bg-gradient-to-b from-blue-500/50 to-transparent"></div>
                )}
                ...
                <div className="relative z-10 w-full max-w-md transform skew-x-0 lg:-skew-x-12 bg-slate-900/40 backdrop-blur-xl border border-white/10 p-8 md:p-12 rounded-2xl shadow-2xl transition-all duration-500 group-hover:border-blue-500/50 group-hover:bg-slate-800/60 overflow-hidden">
                  <div className="absolute top-0 right-0 w-32 h-32 bg-blue-500/10 rounded-full blur-3xl opacity-0 group-hover:opacity-100 transition-opacity"></div>
