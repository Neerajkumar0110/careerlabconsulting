...
export async function POST(req: Request) {
  try {
    ...
    const { status, name, email, phone, score, totalQuestions, scholarshipCode, discount, planName } = body;
    ...
    if (status === 'disqualified') {
        ...
        return NextResponse.json({ success: true, message: 'Disqualification processed' });
    }
